	...
	if(MotionStop == 0)
	{
		...
		else if((time>=0)&&(time<=T))
		{
			...
			*/
			...
			// Finger Motion //
			if((time >= 100) && (time <200)) {PROF_LFingerMotion4_A(100, 200);}
			if((time >= (T-150)) && (time < (T-50))) {PROF_LFingerMotion4_B(T-150, T-50);}
	...
	if(MotionStop == 0)
	{
		...
		else if((time>=0)&&(time<=T))
		{
			...
			if(time == 20)		// grip off a thumb
			{
				...
				Local_TxData[4]=0x10 | (4 & 0x0F);
				Local_TxData[5]=0x10 | (3 & 0x0F);
				Local_TxData[6]=0x10 | (3 & 0x0F);
				Local_TxData[7]=0x10 | (4 & 0x0F);
				CanSendMsg(1, CMD_TXDF, Local_TxData, 8, 0);
			}
			if(time == 75)		// grip off a thumb
			{
				...
				Local_TxData[5]=0x10 | (5 & 0x0F);
				Local_TxData[6]=0x10 | (5 & 0x0F);
				Local_TxData[7]=0x10 | (6 & 0x0F);
				CanSendMsg(1, CMD_TXDF, Local_TxData, 8, 0);
			}
...
void	Motion_RaiseRightHand(int T, char MotionStop,unsigned int MotionNo)
{
	...
	unsigned char Local_TxData[8];
	//Motion Timing
	//define overall timing here? ignore argument for compatibility
		...
		else if((time>=0)&&(time<=T))
		{
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					RightHand_ExtendFingers(125, 76,time,0);
					break;
				case 2:
					...
					RightHand_ExtendFingers(85, 65,time,0);
					break;
				case 0:
				default:
					...
					RightHand_ExtendFingers(200, 100,time,0);
					break;	
			}
		...
		else if((time>=0)&&(time<=T))
		{
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				...
				default:
					...
					RightHand_GripAll(200,95,time,0);
					break;	
			}
		...
		else if((time>=0)&&(time<=T))
		{
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					RightHand_ExtendFingers(5,75,time,1);
					RightHand_ExtendFingers(300,55,time,0);
					break;					
				case 2:
					FTN_half_1_cos(1.0f, time, 0,50, 0, 0, &Output1[0]);
					//X cycle
					...
					RightHand_ExtendFingers(185,50,time,0);
					break;	
				case 0:
				default:
					FTN_half_1_cos(1.0f, time, 0,100, 0, 0, &Output1[0]);
					...
					RightHand_ExtendFingers(550,100,time,0);
					break;	
			}
		...
		else if((time>=0)&&(time<=T))
		{
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					LeftHand_ExtendFingers(125,70,time,0);
					break;
				case 2:
					FTN_half_1_cos(1.0f, time, 0,65, 0, 0, &Output1[0]);
					FTN_half_1_cos(-1.0f, time, 85,65, 0, 0, &Output1[1]);
					LeftHand_ExtendFingers(5,60,time,1);
					LeftHand_ExtendFingers(85,60,time,0);
					break;
				case 0:
				default:
					FTN_half_1_cos(1.0f, time, 0,100, 0, 0, &Output1[0]);
					...
					LeftHand_ExtendFingers(200,95,time,0);
					break;	
			}
			for (int n=0;n<=13;n++)
			{
		...
		else if((time>=0)&&(time<=T))
		{
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					LeftHand_GripAll(125,70,time,0);
					break;
				case 2:
					FTN_half_1_cos(1.0f, time, 0,50, 0, 0, &Output1[0]);
					FTN_half_1_cos(-1.0f, time, 70,50, 0, 0, &Output1[1]);
					LeftHand_GripAll(5,45,time,1);
					LeftHand_GripAll(70,45,time,0);
					break;
				case 0:
				default:
					FTN_half_1_cos(1.0f, time, 0,100, 0, 0, &Output1[0]);
					...
					LeftHand_GripAll(200,95,time,0);
					break;	
			}
		...
		else if((time>=0)&&(time<=T))
		{
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					FTN_half_1_cos(-1.0f, time, 300,60, 0, 0, &Output1[9]);
					LeftHand_GripAll(5,70,time,1);
					LeftHand_GripAll(300,55,time,0);
					break;					
				case 2:
					FTN_half_1_cos(1.0f, time, 0,50, 0, 0, &Output1[0]);
					//X cycle
					...
					FTN_half_1_cos(-1.0f, time, 185,55, 0, 0, &Output1[9]);
					LeftHand_GripAll(5,45,time,1);
					LeftHand_GripAll(185,50,time,0);
					break;	
				case 0:
				default:
					FTN_half_1_cos(1.0f, time, 0,100, 0, 0, &Output1[0]);
					...
					FTN_half_1_cos(-1.0f, time, 550,110, 0, 0, &Output1[9]);
					LeftHand_GripAll(5,95,time,1);
					LeftHand_GripAll(550,105,time,0);
					break;	
			}
...
void	Motion_TouchHead(int T, char MotionStop,unsigned int MotionNo)
{
	...
	if(MotionStop == 0)
	{
		...
		else if((time>=0)&&(time<=T))
		{
			...
			//float Amplitudes1[] = {130,19,40,70,50,5,-5,0,0,0,0,0,0,0}; //reduce elbow motion to be safe while testing hands
			float Amplitudes1[] = {130,19,33,70,50,5,-5,0,0,0,0,0,0,0}; //reduce elbow motion to be safe while testing hands
			float Amplitudes2[] = {  0, -5, 0, 6, 4,0,-5,0,0,0,0,0,0,0};
			// Define additional amplitudes INCREMENTALLY, so you can just add it all together at the end
			float Output[6];
			float Result[6];
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				...
				case 2:
					...
					LeftHand_ExtendFingers(160,70,time,0);
					break;
				case 0:
				default:
					...
					LeftHand_ExtendFingers(260,115,time,0);
					break;	
			}
...
void	Motion_TouchNose(int T, char MotionStop,unsigned int MotionNo)
{
	...
	if(MotionStop == 0)
	{
		...
		else if((time>=0)&&(time<=T))
		{
			...
			//float Amplitudes1[] = {140,24,65,80,50,0,3,0,0,0,0,0,0,0};//good but safe
			float Amplitudes1[] = {135,24,65,75,50,0,3,0,0,0,0,0,0,0};//better positioning
			//float Amplitudes2[] = {0,0,0,0,0,5,-5,0,0,0,0,0,0,0};
			float Amplitudes2[] = {0,-10,0,0,0,5,-5,0,0,0,0,0,0,0};
			// Define additional amplitudes INCREMENTALLY, so you can just add it all together at the end
			float Output[6];
			float Result[6];
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				...
				default:
					...
					RightHand_Index(260,115,time,0);
					break;	
			}
	...
	if(MotionStop == 0)
	{
		...
		else if((time>=0)&&(time<=T))
		{
			...
			*/
			...
			// LSP from 0 to 90 then back to 0 
			FTN_half_1_cos( 1.0f,time,    3,50,0,0,&result1[LSP]);
			FTN_half_1_cos(-1.0f,time,    200,50,0,0,&result2[LSP]);
			res[LSP] = (float)(90.*(result1[LSP]+result2[LSP]));
...
void	Motion_RubStomach(int T, char MotionStop,unsigned int MotionNo)
{
	...
	if(MotionStop == 0)
	{
		...
		else if((time>=0)&&(time<=T))
		{
			...
			float Amplitudes1[] = { 45, 30, 60, 45,20,0,-5,0,0,0,0,0,0,0};//reduce shoulder yaw as well to eliminate collision
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					FTN_half_1_cos(1.0f, time, 190,59, 0, 0, &Output[4]);
					FTN_half_1_cos(-1.0f, time, 249,60, 0, 0, &Output[5]);
					break;
				case 2:
					...
					FTN_half_1_cos(1.0f, time, 125,40, 0, 0, &Output[4]);
					FTN_half_1_cos(-1.0f, time, 160,50, 0, 0, &Output[5]);
					break;
				case 0:
				default:
					FTN_half_1_cos(1.0f, time, 0,100, 0, 0, &Output[0]);
					...
					FTN_half_1_cos(1.0f, time, 250,60, 0, 0, &Output[4]);
					FTN_half_1_cos(-1.0f, time, 309,99, 0, 0, &Output[5]);
					break;	
			}
		...
		else if((time>=0)&&(time<=T))
		{
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					RightHand_GripAll(235,65,time,0);
					break;
				case 2:
					FTN_half_1_cos(1.0f, time, 0,70, 0, 0, &Output[0]);
					...
					RightHand_GripAll(190,65,time,0);
					break;
				case 0:
				default:
					FTN_half_1_cos(1.0f, time, 0,100, 0, 0, &Output[0]);
					...
					RightHand_GripAll(300,95,time,0);
					break;	
			}
		...
		else if((time>=0)&&(time<=T))
		{
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					RightHand_ExtendFingers(210,60,time,0);
					LeftHand_ExtendFingers(5,60,time,1);
					LeftHand_ExtendFingers(210,60,time,0);
					break;
				case 2:
					...
					RightHand_ExtendFingers(160,40,time,0);
					LeftHand_ExtendFingers(5,40,time,1);
					LeftHand_ExtendFingers(160,40,time,0);
					break;
				case 0:
				default:
					FTN_half_1_cos(1.0f, time, 0,100, 0, 0, &Output[0]);
					...
					RightHand_ExtendFingers(5,95,time,1);
					RightHand_ExtendFingers(300,95,time,0);
					LeftHand_ExtendFingers(5,95,time,1);
					LeftHand_ExtendFingers(300,95,time,0);
					break;	
			}
...
void	Motion_FlapArms(int T, char MotionStop,unsigned int MotionNo)
{
	...
	if(MotionStop == 0)
	{
		...
		else if((time>=0)&&(time<=T))
		{
			...
			//reduce elbow swing, reduce shoulder yaw
			float Amplitudes1[] = {25,70,27,70,0,0,0,25,-70,27,70,0,0,0};
			float Amplitudes2[] = {0,-30,8,-5,0,0,0,0,30,8,-5,0,0,0};
			...
			switch(pSharedMemory->JaemiSaysMotionSpeed)
			{
				case 1:
					...
					RightHand_GripAll(210,60,time,0);
					LeftHand_GripAll(0,60,time,1);
					LeftHand_GripAll(210,60,time,0);
				...
				case 2:
					...
					RightHand_GripAll(160,40,time,0);
					LeftHand_GripAll(0,40,time,1);
					LeftHand_GripAll(160,40,time,0);
					break;
				case 0:
				default:
					FTN_half_1_cos(1.0f, time, 0,100, 0, 0, &Output[0]);
					...
					LeftHand_GripAll(300,95,time,0);
					break;	
			}
			//define additional steps here
...
void	LeftHand_Neutral(long start_time, long duration,long time)	
{
	...
	{
		FTN_1_cos(1.0, local_time, 0, duration, 0, 0, &tmp_res[0]);
		FTN_1_cos(1.0, local_time, 0, duration, 0, 0, &tmp_res[1]);
		FTN_1_cos(1.0, local_time, 0, duration, 0, 0, &tmp_res[2]);
		FTN_1_cos(1.0, local_time, 0, duration, 0, 0, &tmp_res[3]);
		FTN_1_cos(1.0, local_time, 0, duration, 0, 0, &tmp_res[4]);
...
void	LeftHand_GripAll(long start_time, long duration, long time, bool direction)	
{
	// Close all fingers
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_LFingerMotion2_A(0,duration) : PROF_LFingerMotion2_B(0,duration); 
	}
}

void	LeftHand_Sweep(long start_time, long duration, long time, bool direction)	
{
	//Sweep open/closed fingers leading with the thumb
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_LFingerMotion3_A(0,duration) : PROF_LFingerMotion3_B(0,duration); 
	}
}

void	LeftHand_ExtendFingers(long start_time, long duration,long time, bool direction)	
{
	//Extend all fingers to flatten hand
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_LFingerMotion4_A(0,duration) : PROF_LFingerMotion4_B(0,duration); 
	}
}


void	LeftHand_ThumbIndex(long start_time, long duration, long time, bool direction)	
{
	//Extend index and thumb, close others
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_LFingerMotion5_A(0,duration) : PROF_LFingerMotion5_B(0,duration); 
	}
}

void	LeftHand_DevilHorns(long start_time, long duration, long time, bool direction)	
{
	//extend index and pinky fingers
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_LFingerMotion6_A(0,duration) : PROF_LFingerMotion6_B(0,duration); 
	}
}


void	LeftHand_Index(long start_time, long duration, long time, bool direction)	
{
	//Extend index finger only
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_LFingerMotion7_A(0,duration) : PROF_LFingerMotion7_B(0,duration); 
	}
}

//########################### - Right Hand - ##################################

void	RightHand_Neutral(long start_time, long duration,long time)	
{
	// Neutral hand position (partially curled)
	long local_time=time-start_time;
	float tmp_res[5];
...
void	RightHand_GripAll(long start_time, long duration, long time, bool direction)	
{
	// Close all fingers
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_RFingerMotion2_A(0,duration) : PROF_RFingerMotion2_B(0,duration); 
	}
}

void	RightHand_Sweep(long start_time, long duration, long time, bool direction)	
{
	//Sweep open/closed fingers leading with the thumb
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_RFingerMotion3_A(0,duration) : PROF_RFingerMotion3_B(0,duration); 
	}
}

void	RightHand_ExtendFingers(long start_time, long duration,long time, bool direction)	
{
	//Extend all fingers to flatten hand
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_RFingerMotion4_A(0,duration) : PROF_RFingerMotion4_B(0,duration); 
	}
}

void	RightHand_ThumbIndex(long start_time, long duration, long time, bool direction)	
{
	//Extend index and thumb, close others
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_RFingerMotion5_A(0,duration) : PROF_RFingerMotion5_B(0,duration); 
	}
}

void	RightHand_DevilHorns(long start_time, long duration, long time, bool direction)	
{
	//extend index and pinky fingers
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_RFingerMotion6_A(0,duration) : PROF_RFingerMotion6_B(0,duration); 
	}
}


void	RightHand_Index(long start_time, long duration, long time, bool direction)	
{
	//Extend index finger only
	long local_time=time-start_time;
	if(local_time>=0 && local_time<=duration)
	{
		direction ? PROF_RFingerMotion7_A(0,duration) : PROF_RFingerMotion7_B(0,duration); 
	}
}
...
//	MotionNo = 44;	// user should change
  ...
  // RSR from 125 to 110 degrees
  FTN_half_1_cos( -1.0f,time,    4000,1200,0,0,&result4[RSR]);
  
  // LSR from -50 to -100 degrees
  FTN_half_1_cos( 1.0f,time,    4000,1200,0,0,&result4[LSR]);
  ...
  */
  ...
  // sum of all movements beginning at different times
	res[RSR] = (float)((-100+125)*(result4[RSR])+((125.-110.)*(result3[RSR])+((110.-90.)*(result2[RSR])+90.*result1[RSR])));
	res[RSY] = (float)((90.+90.)*(result3[RSY])+(90.+90.)*(result2[RSY])-90.*(result1[RSY]));
	res[REB] = (float)((10.+70.)*(result3[REB])+(85.-30.)*(result2[REB])+30.*(result1[REB]));
	res[LSR] = (float)((-50+100)*result4[LSR]*((-50.+25.)*(result3[LSR])+(-25.+90.)*(result2[LSR])-90.*(result1[LSR])));
	res[LSY] = (float)(-90.*(result1[LSY]));
	res[LEB] = (float)((10.+70.)*(result3[LEB])+(85.-30.)*(result2[LEB])+30.*(result1[LEB]));
